...
PASSWORD_HASH=$(docker run --rm httpd:2.4-alpine htpasswd -nbBC 12 admin "$WG_PASSWORD" | cut -d: -f2)
...
echo -e "🆔 Contenedor LXC: $CT_ID"
echo -e "💻 IP local: $CT_IP_ONLY"
echo -e "🌍 Dominio público: $WG_HOST"
echo -e "🔐 Usuario: admin"
echo -e "🔐 Contraseña: (la que ingresaste)"
echo -e "🌐 Web: http://$CT_IP_ONLY:$WG_ADMIN_PORT"
echo -e "📡 Puerto VPN: $WG_PORT/udp (redirige en tu router)"
