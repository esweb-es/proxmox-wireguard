...
# ================================================
# Función: Validar entorno Proxmox
# ================================================
...
# ================================================
# Función: Solicitar configuración al usuario
# ================================================
...
echo
read -rsp "🔐 Contraseña para interfaz web (se usará para generar hash): " WEB_PASSWORD
echo
...
# ================================================
# Instalar Docker y apache2-utils
# ================================================
...
# ================================================
# Generar hash bcrypt dentro del contenedor
# ================================================
echo "🔐 Generando hash seguro..."
HASH=$(pct exec "$CT_ID" -- bash -c "htpasswd -nbBC 12 admin '$WEB_PASSWORD' | cut -d: -f2 | tr -d '\n'")
